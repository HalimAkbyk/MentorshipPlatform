...
namespace MentorshipPlatform.Persistence.Migrations
{
    ...
    [Migration("20260308213318_AddStudentNotesToSessionPlan")]
    partial class AddStudentNotesToSessionPlan
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MentorshipPlatform.Domain.Entities.CreditTransaction", b =>
                {
                    ...
                    b.Property<Guid>("StudentCreditId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MentorshipPlatform.Domain.Entities.FreeSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MentorshipPlatform.Domain.Entities.InstructorAccrual", b =>
                {
                    ...
                    b.Property<int>("GroupLessonCount")
                        .HasColumnType("integer");

                    b.Property<decimal>("GroupLessonUnitPrice")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<int>("PrivateLessonCount")
                        .HasColumnType("integer");

                    b.Property<decimal>("PrivateLessonUnitPrice")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<int>("VideoContentCount")
                        .HasColumnType("integer");

                    b.Property<decimal>("VideoUnitPrice")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.ToTable("InstructorAccruals", (string)null);
                });

            modelBuilder.Entity("MentorshipPlatform.Domain.Entities.InstructorAccrualParameter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("BonusThresholdLessons")
                        .HasColumnType("integer");

                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<decimal>("GroupLessonRate")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<decimal>("PrivateLessonRate")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<decimal>("VideoContentRate")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.ToTable("InstructorAccrualParameters", (string)null);
                });

            modelBuilder.Entity("MentorshipPlatform.Domain.Entities.InstructorPerformanceSummary", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("GroupLessonFillRate")
                        .HasPrecision(5, 2)
                        .HasColumnType("numeric(5,2)");
                    ...
                    b.Property<decimal>("PrivateLessonDemandRate")
                        .HasPrecision(5, 2)
                        .HasColumnType("numeric(5,2)");

                    b.Property<decimal>("TotalCreditRevenue")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<int>("TotalGroupLessons")
                        .HasColumnType("integer");

                    b.Property<int>("TotalLiveDurationMinutes")
                        .HasColumnType("integer");

                    b.Property<int>("TotalPrivateLessons")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("TotalVideoWatchMinutes")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("InstructorId", "PeriodType", "PeriodStart")
                        .IsUnique();

                    b.ToTable("InstructorPerformanceSummaries", (string)null);
                });

            modelBuilder.Entity("MentorshipPlatform.Domain.Entities.InstructorSessionLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("VideoParticipantId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("VideoParticipantId");

                    b.ToTable("InstructorSessionLogs", (string)null);
                });
            ...
            modelBuilder.Entity("MentorshipPlatform.Domain.Entities.LibraryItem", b =>
                {
                    ...
                    b.Property<bool>("IsSharedWithStudents")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("MentorshipPlatform.Domain.Entities.MentorProfile", b =>
                {
                    ...
                    b.Property<bool>("HasPendingReviewRequest")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("MentorshipPlatform.Domain.Entities.Offering", b =>
                {
                    ...
                    b.Property<string>("AdminPriceNote")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("MentorshipPlatform.Domain.Entities.Package", b =>
                {
                    ...
                    b.Property<int>("GroupLessonCredits")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("PrivateLessonCredits")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("VideoAccessCredits")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MentorshipPlatform.Domain.Entities.PackagePurchase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PackagePurchases", (string)null);
                });
            ...
            modelBuilder.Entity("MentorshipPlatform.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("InstructorAssignedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("MentorshipPlatform.Domain.Entities.VideoWatchLog", b =>
                {
                    ...
                    b.Property<DateTime?>("WatchEndedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime>("WatchStartedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("MentorshipPlatform.Domain.Entities.Course", b =>
                {
                    b.HasOne("MentorshipPlatform.Domain.Entities.User", "Instructor")
                        .WithMany()
            ...
            modelBuilder.Entity("MentorshipPlatform.Domain.Entities.CreditTransaction", b =>
                {
                    ...
                    b.HasOne("MentorshipPlatform.Domain.Entities.StudentCredit", "StudentCredit")
                        .WithMany()
                        .HasForeignKey("StudentCreditId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("MentorshipPlatform.Domain.Entities.FreeSession", b =>
                {
                    b.HasOne("MentorshipPlatform.Domain.Entities.CreditTransaction", "CreditTransaction")
                        .WithMany()
            ...
            modelBuilder.Entity("MentorshipPlatform.Domain.Entities.InstructorSessionLog", b =>
                {
                    ...
                    b.HasOne("MentorshipPlatform.Domain.Entities.VideoParticipant", "VideoParticipant")
                        .WithMany()
                        .HasForeignKey("VideoParticipantId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("Instructor");

                    b.Navigation("VideoParticipant");
                });
            ...
            modelBuilder.Entity("MentorshipPlatform.Domain.Entities.PackagePurchase", b =>
                {
                    ...
                    b.HasOne("MentorshipPlatform.Domain.Entities.Package", "Package")
                        .WithMany()
            ...
            modelBuilder.Entity("MentorshipPlatform.Domain.Entities.StudentCredit", b =>
                {
                    b.HasOne("MentorshipPlatform.Domain.Entities.PackagePurchase", "PackagePurchase")
                        .WithMany()
